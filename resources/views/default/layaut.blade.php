...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow bg-color">
      <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#"><img src="{{asset('logo/logo.jpg')}}" alt="logo" width="200px" height="60px"></a>
...
<script src="{{asset('Js/jquery.min.js')}}"></script>
        <script src="{{asset('Js/dashboard.min.js')}}"></script></body>
</html>
